...
public class TampilHasilPenjualan extends AppCompatActivity implements HasilAdaptor.datalistener {
        ...
        @Override
        public void onDeleteData(com.example.projectfirebase.Hasil data, int position) {
            if (reference != null) {
        ...
        public void add_entry(View view) {
            Intent intent=new Intent(TampilHasilPenjualan.this, com.example.projectfirebase.FormulirPegawai.class);
