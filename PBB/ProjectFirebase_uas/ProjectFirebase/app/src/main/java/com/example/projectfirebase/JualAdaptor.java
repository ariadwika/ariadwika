...
public class JualAdaptor extends RecyclerView.Adapter<JualAdaptor.ViewHolder> {
    private final ArrayList<Barang> listbarang;
    private final Context context;

    public JualAdaptor(ArrayList<Barang> listbarang, Context context) {
    ...
    public JualAdaptor.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View V = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_format_tampilan, parent,false);
        return new JualAdaptor.ViewHolder(V);
    }

    @Override
    public void onBindViewHolder(JualAdaptor.ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), Jual_Barang.class);
    ...
    JualAdaptor.datalistener listener;
}
